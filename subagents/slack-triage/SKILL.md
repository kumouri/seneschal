...
compatibility: Requires the Slack MCP (mcp__*__slack_*). Reads the assistant's persona + references.
---
...
**3 — Classify each item** (resolve senders against Notion **People** when useful):
